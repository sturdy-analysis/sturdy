...
colors <- c(rgb(237/256, 248/256, 177/256), rgb(127/256, 205/256, 187/256), rgb(44/256, 127/256, 184/256), rgb(237/256, 248/256, 177/256))
...
b <- boxplot(typeDead, constantDead, constantConstant,
        # main = "Multiple boxplots for comparision",
        names = c("dead code types", "dead code const.", "constant instr."),
        # las = 2,
        # ylim = c(0, 45000),
        col = colors
)
...
memsafeBinaries <- length(which(memsafeInstPercent == 100))
