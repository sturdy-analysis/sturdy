...
final class RelationalAnalysisSimpleTest(using apronManager: apron.Manager) extends AnyFlatSpec, Matchers:
  ...
  val topf64 = Value.Float64(doubleIv(Double.MinValue, Double.MaxValue, FloatSpecials.Top, F64Type))
  val topf64NoSpecials = Value.Float64(doubleIv(Double.MinValue, Double.MaxValue, FloatSpecials.Bottom, F64Type))

  {
    ...
    testFailingFunction(simple, "division", List(i32(ApronExpr.lit(1, I32Type)), i32(ApronExpr.lit(0, I32Type))), IntegerDivisionByZero)
  ...
  testFunction(simple, "nesting", List(topf32NoSpecials, Value.Float32(ApronExpr.floatConstant(DoubleScalar(2), FloatSpecials.Top, F32Type))), List(topf32))
  testFunction(simple, "nesting", List(Value.Float32(ApronExpr.floatConstant(DoubleScalar(1), FloatSpecials.Top, F32Type)), topf32NoSpecials), List(topf32))
  ...
  testFunction(simple, "plus_five", List(i32(ApronExpr.lit(0, I32Type))), List(i32(doubleIv(5, 5, FloatSpecials.Integer, I32Type))))
  testFunction(simple, "loop_to_100", List(i32(ApronExpr.lit(0, I32Type))), List(i32(doubleIv(100, 100, FloatSpecials.Integer, I32Type))))

  testFunction(fact, "fac-rec", List(Value.Int64(ApronExpr.lit(1, I64Type))), List(i64(ApronExpr.lit(1, I64Type))))
  (2 to 8).foreach { arg =>
    testFunction(fact, "fac-rec", List(Value.Int64(ApronExpr.lit(arg, I64Type))), List(topi64))
  }
  testFunction(fact, "fac-rec", List(Value.Int64(ApronExpr.lit(25, I64Type))), List(topi64))
  testFunction(fact, "fac-iter", List(Value.Int64(ApronExpr.lit(25, I64Type))), List(topi64))
  testFunction(fact, "fac-rec-named", List(Value.Int64(ApronExpr.lit(25, I64Type))), List(topi64))
  testFunction(fact, "fac-iter-named", List(Value.Int64(ApronExpr.lit(25, I64Type))), List(topi64))
  testFunction(fact, "fac-opt", List(Value.Int64(ApronExpr.lit(25, I64Type))), List(topi64))
