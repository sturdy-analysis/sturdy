...
//  }

  {
    ...
    //testFailingFunction(simple, "division", List(ConstantAnalysis.Value.Num(ConcreteInterpreter.NumValue.Int32(Topped.Actual(1))),
      //ConstantAnalysis.Value.Num(ConcreteInterpreter.NumValue.Int32(Topped.Actual(0)))), IntegerDivisionByZero)
  ...
  testFunction(simple, "const", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "first", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(1))), Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(1)))))
  testFunction(simple, "first", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top)), Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(2)))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "second", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(1))), Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "second", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top)), Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(2)))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(2)))))
  testFunction(simple, "test-mem", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "nesting", List(Value.Num(ConstantAnalysis.NumValue.Float32(Topped.Top)), Value.Num(ConstantAnalysis.NumValue.Float32(Topped.Actual(2)))), List(Value.Num(ConstantAnalysis.NumValue.Float32(Topped.Top))))
  testFunction(simple, "nesting", List(Value.Num(ConstantAnalysis.NumValue.Float32(Topped.Actual(1))), Value.Num(ConstantAnalysis.NumValue.Float32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Float32(Topped.Top))))
  testFunction(simple, "test-br3", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "test-br-and-return", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "test-br-and-return2", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "test-br-and-return3", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "test-br-and-return4", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(42)))))
  testFunction(simple, "test-unreachable5", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "test-global", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))
  testFunction(simple, "test-call-indirect-parametric", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(0)))))
  testFailingFunction(simple, "division", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Actual(1))), Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), IntegerDivisionByZero)
  testFunction(simple, "effects", List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int32(Topped.Top))))

  testFunction(fact, "fac-rec", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(1)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(1)))))
  (2 to 8).foreach { arg =>
    testFunction(fact, "fac-rec", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(arg)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  }
  testFunction(fact, "fac-rec", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(25)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-iter", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(25)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-rec-named", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(25)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-iter-named", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(25)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-opt", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Actual(25)))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))

  testFunction(fact, "fac-rec", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-iter", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-rec-named", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-iter-named", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
  testFunction(fact, "fac-opt", List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))), List(Value.Num(ConstantAnalysis.NumValue.Int64(Topped.Top))))
