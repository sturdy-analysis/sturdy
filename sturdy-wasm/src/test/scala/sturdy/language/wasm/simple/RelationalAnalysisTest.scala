...
//  testFunction(fact, "fac-rec", List(Value.Int64(NumericInterval.constant(1))), List(Value.Int64(NumericInterval.constant(1))))
  (2 to 8).foreach { arg =>
    testFunction(fact, "fac-rec", List(Value.Int64(ApronExpr.intLit(arg, I32Type))), List(topi64))
  }
  testFunction(fact, "fac-rec", List(Value.Int64(ApronExpr.intLit(25, I32Type))), List(topi64))
  testFunction(fact, "fac-iter", List(Value.Int64(ApronExpr.intLit(25, I32Type))), List(topi64))
  testFunction(fact, "fac-rec-named", List(Value.Int64(ApronExpr.intLit(25, I32Type))), List(topi64))
  testFunction(fact, "fac-iter-named", List(Value.Int64(ApronExpr.intLit(25, I32Type))), List(topi64))
  testFunction(fact, "fac-opt", List(Value.Int64(ApronExpr.intLit(25, I32Type))), List(topi64))
