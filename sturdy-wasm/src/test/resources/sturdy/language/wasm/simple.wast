(module
  ...
  (func (export "operand_stack_is_immutable") (result i32) (local $x i32)
    ...
    local.set $x  (; []     $x = 0             []           $x_recent = 0       ;)
    local.get $x  (; [0]    $x = 0             [x_recent]   $x_recent = 0       ;)
    i32.const 1   (; [1,0]  $x = 0             [1,x_recent] $x_recent = 0       ;)
    local.set $x  (; [0]    $x = 1             [x_recent]   $x_recent = 1       ;)
    return        (; 0 is returned             x_recent is returned             ;)
  )
