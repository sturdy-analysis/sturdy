...
trait Interpreter:
  ...
  type Bytes
  type Size
  type Effects <: GenericEffects[Value, Addr, Bytes, Size]

  type Instance <: GenericInstance

  trait GenericInstance extends GenericInterpreter[Value, Addr, Bytes, Size]:
    implicit val i32Ops: IntOps[I32]
    implicit val i64Ops: LongOps[I64]
    implicit val f32Ops: FloatOps[F32]
    implicit val f64Ops: DoubleOps[F64]
    implicit val i32EqOps: EqOps[I32, Bool]
    implicit val i64EqOps: EqOps[I64, Bool]
    implicit val f32EqOps: EqOps[F32, Bool]
    implicit val f64EqOps: EqOps[F64, Bool]
    implicit val i32CompareOps: CompareOps[I32, Bool]
    implicit val i64CompareOps: CompareOps[I64, Bool]
    implicit val f32CompareOps: CompareOps[F32, Bool]
    implicit val f64CompareOps: CompareOps[F64, Bool]
    implicit val i32IntCompareOps: IntegerCompareOps[I32, Bool]
    implicit val i64IntCompareOps: IntegerCompareOps[I64, Bool]
    implicit val convertI32I64: ConvertIntLong[I32, I64]
    implicit val convertI32F32: ConvertIntFloat[I32, F32]
    implicit val convertI32F64: ConvertIntDouble[I32, F64]
    implicit val convertI64I32: ConvertLongInt[I64, I32]
    implicit val convertI64F32: ConvertLongFloat[I64, F32]
    implicit val convertI64F64: ConvertLongDouble[I64, F64]
    implicit val convertF32I32: ConvertFloatInt[F32, I32]
    implicit val convertF32I64: ConvertFloatLong[F32, I64]
    implicit val convertF32F64: ConvertFloatDouble[F32, F64]
    implicit val convertF64I32: ConvertDoubleInt[F64, I32]
    implicit val convertF64I64: ConvertDoubleLong[F64, I64]
    implicit val convertF64F32: ConvertDoubleFloat[F64, F32]
