...
import sturdy.language.wasm.abstractions.{ConstantValues, ToppedFunctionValue}
...
object ConstantAnalysis extends Interpreter, ConstantValues, ToppedFunctionValue:
