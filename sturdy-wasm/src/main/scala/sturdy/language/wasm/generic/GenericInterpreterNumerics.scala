...
class GenericInterpreterNumerics[V, J[_] <: MayJoin[_]]
  ...
  inline def evalIBinop(op: IBinop, v1: V, v2: V): V = op match
    ...
    case i32.DivS =>
      ...
      branchOps.boolBranch(noOverflow, (), Failure(IntegerDivisionByZero, s"$v1 / $v2"))
      i32ops.div(v1, v2)
    ...
    case i32.Shl => i32ops.shiftLeft(v1, v2)
    case i32.ShrS => i32ops.shiftRight(v1, v2)
    case i32.ShrU => i32ops.shiftRightUnsigned(v1, v2)
    case i32.Rotl => i32ops.rotateLeft(v1, v2)
    case i32.Rotr => i32ops.rotateRight(v1, v2)
    ...
    case i64.DivS =>
      ...
      val noOverflow = i32ops.add(v1NotMinValue, v2NotNeg1)
      wasmOps.branchOps.boolBranch(noOverflow, (), Failure(IntegerDivisionByZero, s"$v1 / $v2"))
      i64ops.div(v1, v2)
    ...
    case i64.Shl => i64ops.shiftLeft(v1, v2)
    case i64.ShrS => i64ops.shiftRight(v1, v2)
    case i64.ShrU => i64ops.shiftRightUnsigned(v1, v2)
    case i64.Rotl => i64ops.rotateLeft(v1, v2)
    case i64.Rotr => i64ops.rotateRight(v1, v2)
