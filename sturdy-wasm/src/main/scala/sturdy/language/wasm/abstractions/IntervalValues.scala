...
import sturdy.values.floating.{FloatingInterval, given}
...
trait FloatingIntervalValues extends Interpreter:
  final type I32 = NumericInterval[Int]
  final type I64 = NumericInterval[Long]
  final type F32 = FloatingInterval[Float]
  final type F64 = FloatingInterval[Double]
  final type Bool = Topped[Boolean]

  final def topI32: I32 = NumericInterval(Integer.MIN_VALUE, Integer.MAX_VALUE)
  final def topI64: I64 = NumericInterval(Long.MinValue, Long.MaxValue)
  final def topF32: F32 = FloatingInterval(Float.NegativeInfinity, Float.PositiveInfinity, true)
  final def topF64: F64 = FloatingInterval(Double.NegativeInfinity, Double.PositiveInfinity, true)
