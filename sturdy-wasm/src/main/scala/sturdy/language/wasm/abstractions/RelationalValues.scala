...
//import sturdy.values.{Combine, Finite, Join, MaybeChanged, Topped, Unchanged, Widen, Widening, config, given}
//import sturdy.values.booleans.given
//import sturdy.values.config.{Bits, BytesSize, Overflow}
//import sturdy.values.convert.{&&, Convert, ConvertConfig, NilCC, SomeCC}
...
//
//  given ConvertIntLong[Type,Type] = (_from: Type, _conf: Bits) => I64Type
//  given ConvertIntFloat[Type,Type] = (_from: Type, _conf: Bits) => F32Type
//  given ConvertIntDouble[Type,Type] = (_from: Type, _conf: Bits) => F64Type
//
//  given ConvertIntBytes[Type, Seq[Type]] = (_from:Type, _conf: BytesSize && SomeCC[ByteOrder]) => ???
//  given ConvertBytesInt[Seq[Type], Type] = Convert[Seq[Byte], Int, VFrom, VTo, config.BytesSize && SomeCC[ByteOrder] && config.Bits]
//
//
//  given ConvertLongInt[Type, Type] = (_from: Type, _conf: NilCC.type) => I32Type
//  given ConvertLongFloat[Type, Type] = (_from: Type, _conf: Bits) => F32Type
//  given ConvertLongDouble[Type, Type] = (_from: Type, _conf: Bits) => F64Type
//
//  given ConvertFloatInt[Type, Type] = (_from: Type, _conf: Overflow && Bits) => I32Type
//  given ConvertFloatLong[Type, Type] = (_from: Type, _conf: Overflow && Bits) => I64Type
//  given ConvertFloatDouble[Type, Type] = (_from: Type, _conf: NilCC.type) => F64Type
//
//  given ConvertDoubleInt[Type, Type] = (_from: Type, _conf: Overflow && Bits) => I32Type
//  given ConvertDoubleLong[Type, Type] = (_from: Type, _conf: Overflow && Bits) => I64Type
//  given ConvertDoubleFloat[Type, Type] = (_from: Type, _conf: NilCC.type) => F32Type
//
//
...
//  final type Bytes = Seq[ApronExpr[VAddr, Type]]
