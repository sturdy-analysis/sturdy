...
object ConcreteInterpreter extends Interpreter :
  ...
  class Instance(effects: Effects)
    ...
    val i32Ops: IntOps[I32] = implicitly
    val i64Ops: LongOps[I64] = implicitly
    val f32Ops: FloatOps[F32] = implicitly
    val f64Ops: DoubleOps[F64] = implicitly
    val i32EqOps: EqOps[I32, Bool] = implicitly
    val i64EqOps: EqOps[I64, Bool] = implicitly
    val f32EqOps: EqOps[F32, Bool] = implicitly
    val f64EqOps: EqOps[F64, Bool] = implicitly
    val i32CompareOps: CompareOps[I32, Bool] = implicitly
    val i64CompareOps: CompareOps[I64, Bool] = implicitly
    val f32CompareOps: CompareOps[F32, Bool] = implicitly
    val f64CompareOps: CompareOps[F64, Bool] = implicitly
    val i32IntCompareOps: IntegerCompareOps[I32, Bool] = implicitly
    val i64IntCompareOps: IntegerCompareOps[I64, Bool] = implicitly
    val convertI32I64: ConvertIntLong[I32, I64] = implicitly
    val convertI32F32: ConvertIntFloat[I32, F32] = implicitly
    val convertI32F64: ConvertIntDouble[I32, F64] = implicitly
    val convertI64I32: ConvertLongInt[I64, I32] = implicitly
    val convertI64F32: ConvertLongFloat[I64, F32] = implicitly
    val convertI64F64: ConvertLongDouble[I64, F64] = implicitly
    val convertF32I32: ConvertFloatInt[F32, I32] = implicitly
    val convertF32I64: ConvertFloatLong[F32, I64] = implicitly
    val convertF32F64: ConvertFloatDouble[F32, F64] = implicitly
    val convertF64I32: ConvertDoubleInt[F64, I32] = implicitly
    val convertF64I64: ConvertDoubleLong[F64, I64] = implicitly
    val convertF64F32: ConvertDoubleFloat[F64, F32] = implicitly
