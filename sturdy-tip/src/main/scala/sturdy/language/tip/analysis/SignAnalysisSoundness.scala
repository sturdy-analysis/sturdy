...
object SignAnalysisSoundness:
  ...
  given Soundness[ConcreteInterpreter.Instance, SignAnalysis.UnfixedInstance] with
    def isSound(c: ConcreteInterpreter.Instance, a: SignAnalysis.UnfixedInstance): IsSound = {
