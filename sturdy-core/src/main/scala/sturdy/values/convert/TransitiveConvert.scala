...
final class TransitiveConvert[From, Via, To, VFrom, VVia, VTo, Config1 <: ConvertConfig[_], Config2 <: ConvertConfig[_]]
  ...
  inline override def apply(from: VFrom, conf: Config1 && Config2): VTo =
