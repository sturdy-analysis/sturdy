...
trait ObjectOps[Addr, Idx, OID, V, CF, OV, Site, Mth, J[_] <: MayJoin[_]]:
...
given ConcreteObjectOps[Addr, OID, V, Site, CF, Mth]
    (using alloc: Allocation[Addr, Site], store: Store[Addr, V, NoJoin]): ObjectOps[Addr, Int, OID, V, CF, Object[OID,CF,Addr], Site, Mth, NoJoin] with
  ...
  //override def invokeFunction(obj: Object[CF, Addr], mth: Mth, args: Seq[V])(invoke: (Object[CF, Addr], Mth, Seq[V]) => V): V =
  //  invoke(obj, mth, args)
