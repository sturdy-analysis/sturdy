...
class LiftedIntegerOpsWithSignInterpretation[B, V, I](byteSize: Int, extract: V => I, inject: I => V)(using ops: IntegerOpsWithSignInterpretation[B, I]) extends LiftedIntegerOps[B,V,I](extract, inject) with IntegerOpsWithSignInterpretation[B, V](byteSize = byteSize):
