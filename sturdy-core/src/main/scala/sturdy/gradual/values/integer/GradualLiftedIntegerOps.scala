...
class GradualLiftedIntegerOps[B, V, I, Gradual[X, Y] <: IntegerOpsGradualization[X, Y]](extract: V => I, inject: I => V)(using ops: GradualIntegerOps[B, I, Gradual]) extends GradualIntegerOps[B, V, Gradual]:
