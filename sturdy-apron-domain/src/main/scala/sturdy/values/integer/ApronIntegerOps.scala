...
given ApronIntegerOps[B, Data, Var](using Numeric[B])
                                   (using callframe: ApronCallFrame[Data, Var], effects : EffectStack, intervalOps: IntervalIntegerOps[Double], f : Failure)
