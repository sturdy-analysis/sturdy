...
object ConcreteInterpreter extends Interpreter:
  ...
  class Instance(proj: Project[URL], initStore: Map[Addr, Value]) extends GenericInstance:
    ...
    override val frame: ConcreteCallFrame[FrameData, Int, Value, Site] = ConcreteCallFrame[FrameData, Int, Value, Site](newFrameData, args.view.zipWithIndex.map((x, y) => (y, x)))
