...
trait Interpreter:
  ...
  (using failure: Failure
   ...
   , refSizeOps: SizeOps[RefValue, Bool]
    ...
    private def i32_from_i8: I8 => Value = (convertI8I32.apply(_, BitSign.Signed)).andThen(Value.Int32.apply)

    private def i32_from_i16: I16 => Value = (convertI16I32.apply(_, BitSign.Signed)).andThen(Value.Int32.apply)
